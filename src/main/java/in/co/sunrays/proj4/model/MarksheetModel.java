  ...
  log.debug("Model update End");
	  ...
	  */
	  ...
	  public List getMeritList(int pageNo,int pageSize)throws ApplicationException
	  {
		  ...
		  StringBuffer sql=new StringBuffer( "SELECT `ID`,`ROLL_NO`, `NAME`, `PHYSICS`, `CHEMISTRY`, `MATHS` , (PHYSICS + CHEMISTRY + MATHS) as total from `ST_MARKSHEET` where (physics>32 AND chemistry>32 AND maths>32) order by total desc");
