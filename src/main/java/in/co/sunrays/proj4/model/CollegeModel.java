...
public class CollegeModel 
{
	 ...
	 /**
	    ...
	    public long add(CollegeBean bean) throws ApplicationException,DuplicateRecordException
	    {
	       ...
	       // CollegeBean collegeBean=findByName(bean.getName());
	        
	       // System.out.println("college add first");
	        
	       // CollegeModel cModel= new CollegeModel();
	       // System.out.println("college add second ");
	      
			
	       // System.out.println("uu"+collegeBean.getName());
			//bean.setName(collegeBean.getName());
			//System.out.println("college add third");
	    ...
	    public List search(CollegeBean bean, int pageNo, int pageSize)throws ApplicationException 
	    {
	        ...
	        if (bean != null)
	        {
	            ...
	            {
	            	System.out.print("in the search");
	            ...
	            {
	                sql.append(" AND COLLEGE_ID = " + bean.getName());
	            }
	        */
