...
public class MarksheetCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		else
		{
			...
			bean.setPhysicsS(DataUtility.getString(request.getParameter("physics")));
			
		}
		
		
		if(DataValidator.isInteger(request.getParameter("chemistry")) && DataValidator.isNotNull(request.getParameter("chemistry")))
		{
		...
		{
			bean.setChemistryY(DataUtility.getString(request.getParameter("chemistry")));
			
		}
		
		if(DataValidator.isInteger(request.getParameter("maths")) && DataValidator.isNotNull(request.getParameter("maths"))){
		...
		{
			bean.setMathsS(DataUtility.getString(request.getParameter("maths")));
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (id > 0) {
			...
			try {
				...
				System.out.println("im phy from model :::::::"+bean.getPhysics()+"physSSS"+bean.getPhysicsS());
